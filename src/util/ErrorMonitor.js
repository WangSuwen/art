...
(function () {
  ...
  */
  var defaults = {
    ...
    line: '', //错误所在的行
    col: '', //错误所在的列
    errorStack: '', //具体的错误堆栈信息
    pageUrl: '', // js所在页面 location.href
  };
  /*
  *ajax封装
  */
  ...
  var badJsReport = function (params) {
    ...
    window.onerror = function (msg, url, line, col, error) {
      ...
      setTimeout(function () {
        ...
        defaults.col = col;
        defaults.msg = msg;
        defaults.pageUrl = window.location.href;
        if (error && error.stack) {
          //如果浏览器有堆栈信息，直接使用
          defaults.errorStack = error.stack.toString();
